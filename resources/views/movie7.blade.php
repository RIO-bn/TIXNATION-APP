...
<nav class="Nav" >
    ...
    <div class="movie-page-container1">
        <div class="movie-img">
            <img src="img/weliveintime.webp" alt="">
        </div>
        <div class="criteria">
            <h2>We Live In Time </h2>
            <p>After an unusual encounter, a talented chef and a recently divorced man fall in love and build the home and family<br>
                 they've always dreamed of, until a painful truth puts their love story to the test. <br>
                 The film uses a nonlinear narrative, showing snapshots of their relationship over a decade.   
