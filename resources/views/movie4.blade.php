...
<nav class="Nav" >
    ...
    <div class="movie-page-container1">
        <div class="movie-img">
            <img src="img/NUN2.webp" alt="">
        </div>
        <div class="criteria">
            <h2>Nun 2 </h2>
            <p>Following a string of mysterious deaths, Sister Irene is called back into <br>
                 She teams up with a young novice to face the powerful demon Valak as its terror spreads across Europe. </p>   
...
<div class="icon-text">
    ...
    <div>
    <h3>Writers</h3>
    <p>Akela Cooper (screenplay by / story by)</p>
    </div>
    <div>
    <h3>Production</h3>
    <p>New Line Cinema</p>
